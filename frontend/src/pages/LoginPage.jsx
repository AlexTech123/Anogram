...
export default function LoginPage() {
  return (
    ...
    >
      ...
      />
      <div
        className="fixed bottom-10 right-1/4 w-72 h-72 rounded-full pointer-events-none"
      ...
      <div className="w-full max-w-sm animate-pop" style={{ zIndex: 10 }}>
        ...
        <div className="flex flex-col items-center mb-8 gap-2">
          ...
          <p className="text-sm" style={{ color: "var(--text-secondary)" }}>Your private messenger</p>
        </div>
