      ...
      >
        ...
        {!hasText && !recording ? (
          <button
            ...
            disabled={uploading}
            title="Voice message"
            className="flex-shrink-0 w-10 h-10 rounded-2xl flex items-center justify-center transition-all duration-150 active:scale-90"
            style={{ background: "var(--bg-elevated)", color: "var(--text-muted)", opacity: uploading ? .4 : 1 }}
          ...
          <button
            ...
            style={{ background: "rgba(239,68,68,.85)", boxShadow: "0 4px 16px rgba(239,68,68,.4)" }}
          >
